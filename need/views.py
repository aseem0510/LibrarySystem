    ...
    if request.method == "POST":
        ...
        if BookCollection.objects.filter(name=name).exists():    
            ...
            if lst == []:
                ...
                # displaying warning message if we have book but of different author.
                messages.warning(request, "Sorry!! We have this book but of different author..!!")
            ...
            # displaying warning message if we don't have this book.
            messages.warning(request, "Sorry!! We don't have this book in our library, Please search anyother book..!!")
        ...
        if lst == []:
            ...
            if obj.quantity != 0:     
                ...
                if temp.is_authenticated:
                    ...
                    print("Dont Enter Others Details")
