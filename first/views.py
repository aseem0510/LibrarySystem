...
# importing it for displaying the message after the successful submission of entries
...
def contact(request):
    ...
    if request.method == "POST":
        ...
        # displaying success message after the successfully submission of user contact query.
        messages.success(request, "We received your Concern, our Representatives will reach to you soon!!")
...
def testing(request):
    ...
    if request.method == "POST":
        ...
        # displaying success message after the successfully submission of testing form.
